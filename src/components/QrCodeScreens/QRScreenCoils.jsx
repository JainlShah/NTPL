...
const QRScreenCoils = ({ value, onClose, title }) => {
  useEffect(() => {
  ...
  //           .qr-item { width: 2in; height: 4in; }
  //           .qr-container { width: 1.5in; height: 1.5in; }
  //           .details-container { font-size: 12px; text-align: center; }
  //         }
  //       </style>
  //     </head>
  //     <body>
          ...
          <div className="qr-item">
            <div className="left-section">
              ...
              {(value.status) ? (
                ...
                >
                  {value.status === "PARTIALUTILIZE" ? "PARTIAL UTILIZED" : value.status}
                </p>
              ) : <></>}
              <div className="qr-container">
                <QRCode
            ...
            <div className="barcode-details-container">
              <div className="detail-row">
                <span className="key">Width:</span>
                <span className="value">{value.width} mm</span>
              </div>
              <div className="detail-row">
                <span className="key">Weight:</span>
                <span className="value">{value.weight} KG</span>
              </div>
              <div className="detail-row">
                <span className="key">Grade:</span>
                <span className="value">{value.grade}</span>
              </div>
              <div className="detail-row">
                <span className="key">Material Type:</span>
                <span className="value">{value.materialType}</span>
              </div>
              <div className="detail-row">
                <span className="key">Date:</span>
                <span className="value">{value.registeredDate}</span>
              </div>
            </div>
          </div>
        )}
